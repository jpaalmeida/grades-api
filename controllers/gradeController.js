...
const update = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res.send({ message: `Grade id: ${id} não encontrado para atualização` });
    } else res.send({ message: 'Grade atualizado com sucesso' });
...
const remove = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res.send({ message: `Grade id: ${id} não encontrado para deleção` });
    } else res.send({ message: 'Grade excluido com sucesso' });
